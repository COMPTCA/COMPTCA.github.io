...
class States extends JFrame implements ItemListener
{
	...
	public void itemStateChanged(ItemEvent event)
	{
		...
		if ((event.getItemSelectable()== chk) && (event.getStateChange() == ItemEvent.SELECTED)) txtArea.append("\nPepperoni selected\n");
		if ((event.getItemSelectable()== box) && (event.getStateChange() == ItemEvent.SELECTED)) txtArea.append(event.getItem().toString() + " selected");
	}
